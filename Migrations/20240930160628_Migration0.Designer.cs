...
namespace Migrations
{
    ...
    [Migration("20240930160628_Migration0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entities.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Entities.ItemCarrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Entities.Perfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Entities.ItemCarrinho", b =>
                {
                    b.HasOne("Model.Entities.Carrinho", "Carrinho")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("Model.Entities.Perfil", b =>
                {
                    b.HasOne("Model.Entities.Cliente", "Cliente")
                        .WithOne("Perfil")
                        .HasForeignKey("Model.Entities.Perfil", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
